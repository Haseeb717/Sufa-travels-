class FoodExpendituresController < ApplicationController
  ...
  private
    ...
    def food_expenditure_params
      params.require(:food_expenditure).permit(:voucher_reference,:guest_name,:on_request_of,:food_type, :expenditure_type, :hotel_name, :payment, :no_of_persons,:comments,:image)
    end
end