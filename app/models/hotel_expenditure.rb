class HotelExpenditure < ActiveRecord::Base
  ...
  enum room_type: [:D_standard,:Dsuprier,:D_classic,:D_suprier_HV,:D_Delux,:D_Delux_HV,:D_Twin_room,:D_PartiaL_HV,:D_Kaaba_View,:T_standard,:T_suprier,:T_classic,:T_suprier_HV,:T_Delux,:T_Delux_HV,:T_PartiaL_HV,:T_Kaaba_View,:Q_standard,:Q_suprier,:Q_classic,:Q_suprier_HV,:Q_Delux,:Q_Delux_HV,:Q_PartiaL_HV,:Q_Kaaba_View,:Selective_Beds,:Multiple_Rooms]
