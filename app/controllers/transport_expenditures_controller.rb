class TransportExpendituresController < ApplicationController
  ...
  private
    ...
    def transport_expenditure_params
      params.require(:transport_expenditure).permit(:voucher_reference,:guest_name,:supplier_name,:transport_type, :expenditure_type, :no_of_seats, :arrival_time, :departure_time, :arrival_place, :departure_place, :payment, :user_id,:image,:date,:created_at)
    end
end